...
void sm::ui_log_msg(log_msg_type_t msgType, const char* msg)
{

}

void sm::ui_log_msg_format(log_msg_type_t msgType, const char* fmt, ...)
{

}

void sm::ui_clear_msg_log(log_msg_type_t msgType)
{
