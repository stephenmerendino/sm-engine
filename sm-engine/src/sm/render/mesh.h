...
namespace sm
{
    ...
    void mesh_add_cone(mesh_t* mesh, const vec3_t& base_center, const vec3_t& dir, f32 height, f32 radius, u32 resolution = 32, const color_f32_t& vertex_color = color_f32_t::WHITE);
    ...
    void mesh_add_torus(mesh_t* mesh, const vec3_t& center, const vec3_t& normal, f32 radius, f32 thickness, u32 resolution = 32, const color_f32_t& vertex_color = color_f32_t::WHITE);
