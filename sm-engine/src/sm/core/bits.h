...
namespace sm
{
    constexpr inline bool is_only_bit_set(u8 bits, u8 flag) { return (bits & ~flag) == 0; }
    ...
    constexpr inline bool is_only_bit_set(u16 bits, u16 flag) { return (bits & ~flag) == 0; }
    ...
    constexpr inline bool is_only_bit_set(u32 bits, u32 flag) { return (bits & ~flag) == 0; }
    ...
    constexpr inline bool is_only_bit_set(u64 bits, u64 flag) { return (bits & ~flag) == 0; }
