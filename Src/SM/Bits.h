...
namespace SM
{
    ...
    constexpr inline bool IsBitSet(U8 bits, U8 flag) { return (bits & flag) == flag; }
    ...
    constexpr inline bool IsBitSet(U16 bits, U16 flag) { return (bits & flag) == flag; }
    ...
    constexpr inline bool IsBitSet(U32 bits, U32 flag) { return (bits & flag) == flag; }
    ...
    constexpr inline bool IsBitSet(U64 bits, U64 flag) { return (bits & flag) == flag; }
